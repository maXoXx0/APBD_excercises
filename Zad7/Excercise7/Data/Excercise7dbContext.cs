...
namespace Excercise7.Data;

public partial class Excercise7dbContext : DbContext
{
    public Excercise7dbContext()
    {
    }

    public Excercise7dbContext(DbContextOptions<Excercise7dbContext> options)
        : base(options)
    {
    }
